...
export default function ProjectCard({ project }: ProjectCardProps) {
    ...
    const isVideo = !!(project.video_link && (project.video_link.includes("youtube.com") || project.video_link.includes("youtu.be")));
                ...
                <div className="flex flex-col h-full p-5">
                    ...
                    <div className="relative overflow-hidden rounded-2xl aspect-video mb-5 shadow-lg bg-black isolate">
                        {isVideo ? (
                            <AnimatePresence mode="wait">
                                {isPlaying ? (
                                    ...
                                    >
                                        ...
                                        >
                                            <Image
                                                src={project.cover_image.startsWith("http") || project.cover_image.startsWith("/") ? project.cover_image : `https://img.youtube.com/vi/${project.cover_image}/maxresdefault.jpg`}
                            ...
                            <Link href={`/project/${project.id}`} className="relative w-full h-full block group/thumb">
                                <Image
                                ...
                                />
                                {/* Hover Overlay */}
                                <div className="absolute inset-0 bg-black/10 group-hover/thumb:bg-black/30 transition-colors duration-300" />
