    ...
    return (
        <section className="relative h-screen min-h-[800px] flex items-center justify-center overflow-hidden">
            ...
            <div className="relative z-10 text-center px-4 md:px-8 max-w-6xl mx-auto w-full">
                ...
                >
                    Optimizing financial health, tax planning, and ledger accuracy — with style, precision, and <span className="text-white font-medium drop-shadow-[0_0_15px_rgba(255,255,255,0.4)]">data-driven insights</span>.
                </m.p>
