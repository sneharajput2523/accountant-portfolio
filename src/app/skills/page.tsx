...
const iconMap = [
  { icon: <Search size={20} />, bg: "#0ea5e9" }, // Onboarding & Audit
  { icon: <FolderDown size={20} />, bg: "#a855f7" }, // Document Collection
  { icon: <Calculator size={20} />, bg: "#f97316" }, // Tally Prime Entry
  { icon: <RefreshCw size={20} />, bg: "#10b981" }, // Reconciliation
  { icon: <BarChart3 size={20} />, bg: "#f43f5e" }, // Excel Reporting
  { icon: <FileCheck size={20} />, bg: "#6366f1" }, // Compliance Filing
];
      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-gray-400 text-lg md:text-xl max-w-3xl mx-auto font-light leading-relaxed relative z-10">
            With hands-on experience in Tally Prime, financial reporting, and tax compliance, I
            bring accuracy, organization, and peace of mind to your business accounts.
          </p>
        </m.div>
        ...
        <CTASection
          ...
          description="Let's discuss your bookkeeping or taxation needs and get your books perfectly organized. I'm here to help you manage your finances with precision."
