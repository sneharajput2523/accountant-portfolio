              ...
              <div className="space-y-6">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <a
                      href="mailto:sneharajput1282@gmail.com"
                      className="text-white hover:text-blue-400 transition-colors"
                    >
                      sneharajput1282@gmail.com
                    </a>
                  </div>
                </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-sm">
                      Flawless ledger entries and precise tax reporting
                    </p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
            ...
            <GlassmorphismCard className="p-8">
              ...
              <form className="space-y-6" onSubmit={handleSubmit}>
                ...
                <div>
                  ...
                  >
                    <option value="" className="bg-gray-900 text-gray-400">Select service type</option>
                    <option value="gst-tax" className="bg-gray-900">GST & Tax Compliance</option>
                    <option value="bookkeeping" className="bg-gray-900">Corporate Bookkeeping</option>
                    <option value="audit" className="bg-gray-900">Financial Auditing</option>
                    <option value="payroll" className="bg-gray-900">Payroll Management</option>
                    <option value="statements" className="bg-gray-900">Financial Statements</option>
                    <option value="other" className="bg-gray-900">Other Consultations</option>
                  </select>
                </div>
