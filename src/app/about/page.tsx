      ...
      <div className="max-w-7xl mx-auto w-full">
        ...
        >
          <h1 className="text-4xl md:text-6xl font-bold mt-0 md:mt-20 mb-3 text-white tracking-tight">
            The Expert Behind the <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-purple-500">Numbers</span>
          </h1>
          <p className="text-gray-400 text-lg max-w-2xl mx-auto">
            Financial Analyst. Tax Consultant. Detail-Oriented Accountant.
          </p>
        </m.div>
        ...
        <BentoGrid className="max-w-6xl mx-auto mb-20">
          ...
          >
            <BentoGridItem
              title="Experience"
              description="Years of professional ledger management."
              header={
                <div className="flex flex-1 w-full h-full min-h-[6rem] rounded-xl bg-gradient-to-br from-black to-neutral-900 border border-white/10 flex flex-col items-center justify-center relative overflow-hidden group-hover:border-emerald-500/30 transition-colors py-8 md:py-0">
                  ...
                  <span className="text-6xl md:text-8xl font-black text-transparent bg-clip-text bg-gradient-to-b from-emerald-400 to-emerald-900 z-10">1.5+</span>
          ...
          >
            <BentoGridItem
              title="Philosophy"
              description="Accuracy above all."
              header={
                <div className="flex flex-1 w-full h-full min-h-[6rem] rounded-xl bg-gradient-to-br from-neutral-900 to-black border border-white/5 p-6 flex items-center">
                  ...
                  <p className="text-gray-300 italic text-sm md:text-base leading-relaxed relative z-10">
                    "Accounting isn't just about balancing sheets; it's about building financial integrity, saving tax expenses, and uncovering growth insights."
                  </p>
                </div>
              }
              className="h-full"
            ...
            <BentoGridItem
              ...
              header={
                <div className="flex flex-1 h-full w-full items-center justify-between px-6 bg-gradient-to-r from-neutral-900 to-neutral-800 rounded-xl border border-white/5 py-4 md:py-0 min-h-[5rem]">
                  <a href="https://linkedin.com/" target="_blank" className="p-3 bg-white/5 rounded-full hover:bg-[#0077b5] hover:scale-110 transition-all duration-300 text-white"><Linkedin size={20} /></a>
                  <a href="mailto:sneharajput1282@gmail.com" className="p-3 bg-white/5 rounded-full hover:bg-orange-600 hover:scale-110 transition-all duration-300 text-white"><Mail size={20} /></a>
                  <a href="https://wa.me/919238366930" target="_blank" className="p-3 bg-white/5 rounded-full hover:bg-green-600 hover:scale-110 transition-all duration-300 text-white"><MessageCircle size={20} /></a>
                </div>
              }
              className="h-full"
